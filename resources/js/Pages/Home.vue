    ...
    <div>
        ...
        <nav>
            <div class=" main-nav d-flex justify-content-around navbar navbar-expand-lg navbar-light bg-white ">
                ...
                <section class="">
                    <figure class=" logo ">
                        <img :src="assetPath(asset, 'log-removebg-preview.png')" class="w-100 d-inline-block m-0 p-0"
                            alt="cart">
                    </figure>
                </section>
                <section>
        ...
        <div class="container">
            ...
            <div class=" my-5  d-flex justify-content-end flex-column">
                ...
                <ul class="list-unstyled d-flex flex-wrap justify-content-around w-100 py-5 ">
                    ...
                    <li class="text-center">
                        <img :src="assetPath(asset, 'log-removebg-preview.png')" class="w-100 d-inline-block m-0 p-0 logo"
                            alt="">
                    </li>
                </ul>
